...
case $VERSION_CHOICE in
    1)
        STREMIO_VERSION="5.1.19"
        echo "Selected: Stremio v5.1.19"
        if [[ "$ARCH" == "arm64" ]]; then
            STREMIO_URL="https://dl.strem.io/stremio-shell-macos/v5.1.19/Stremio_arm64.dmg"
            MOUNT_POINT="/Volumes/Stremio v5.1.19 arm64"
        elif [[ "$ARCH" == "x86_64" ]]; then
            STREMIO_URL="https://dl.strem.io/stremio-shell-macos/v5.1.19/Stremio_x64.dmg"
            MOUNT_POINT="/Volumes/Stremio v5.1.19 x64"
        else
